...
export interface FileswapV2Router01Interface extends utils.Interface {
  functions: {
...
export interface FileswapV2Router01 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FileswapV2Router01Interface;
