...
export interface IFileswapV2MigratorInterface extends utils.Interface {
  functions: {
...
export interface IFileswapV2Migrator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IFileswapV2MigratorInterface;
