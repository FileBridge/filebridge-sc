...
export interface IFileswapV2Router01Interface extends utils.Interface {
  functions: {
...
export interface IFileswapV2Router01 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IFileswapV2Router01Interface;
