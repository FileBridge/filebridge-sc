...
export interface IFileswapV1ExchangeInterface extends utils.Interface {
  functions: {
...
export interface IFileswapV1Exchange extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IFileswapV1ExchangeInterface;
