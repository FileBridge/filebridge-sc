...
export interface IFileswapV2Router02Interface extends utils.Interface {
  functions: {
...
export interface IFileswapV2Router02 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IFileswapV2Router02Interface;
