...
export interface FileswapV2MigratorInterface extends utils.Interface {
  functions: {
...
export interface FileswapV2Migrator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FileswapV2MigratorInterface;
