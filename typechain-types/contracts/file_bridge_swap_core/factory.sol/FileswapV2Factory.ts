...
export interface FileswapV2FactoryInterface extends utils.Interface {
  functions: {
...
export interface FileswapV2Factory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FileswapV2FactoryInterface;
