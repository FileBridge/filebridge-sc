...
export interface IFileswapV2FactoryInterface extends utils.Interface {
  functions: {
...
export interface IFileswapV2Factory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IFileswapV2FactoryInterface;
