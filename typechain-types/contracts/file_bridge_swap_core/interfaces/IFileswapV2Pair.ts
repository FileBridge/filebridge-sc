...
export interface IFileswapV2PairInterface extends utils.Interface {
  functions: {
...
export interface IFileswapV2Pair extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IFileswapV2PairInterface;
